...
// router.route('/api/getAgent').get(routesControl.getAgent_get);

//## VERIF DES COOKIES
// router.route('/api/checkCookies').get(routesControl.apiGetCookie);

//##                  Comportement utilisateur                           -

// router.route('/api/info').get(routesControl.apiGetCookie);
...
// router.route('/api/checkUserStatus').get(routesControl.checkUser);
